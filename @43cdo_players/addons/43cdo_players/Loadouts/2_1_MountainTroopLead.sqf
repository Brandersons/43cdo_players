...
_this addWeapon "UK3CB_BAF_L115A3_DE";
_this addPrimaryWeaponItem "kt_25x_PMII022_msr_ti";
_this addPrimaryWeaponItem "UK3CB_BAF_Silencer_L115A3";
_this addPrimaryWeaponItem "UK3CB_underbarrel_acc_bipod";
_this addPrimaryWeaponItem "L115_5Rnd_338_Scenar_Mag";
...
if (_PlayerVest isEqualTo "") then 
	{
		...
		_this addItemToVest "rhsusf_acc_omega9k";

		for "_i" from 1 to 3 do {_this addItemToVest "rhs_mag_m67";};
		for "_i" from 1 to 3 do {_this addItemToVest "UK3CB_BAF_SmokeShell";};
		for "_i" from 1 to 4 do {_this addItemToVest "L115_5Rnd_338_Scenar_Mag";};
		for "_i" from 1 to 5 do {_this addItemToVest "L115_5Rnd_338_Scenar_Mag_tr";};
		for "_i" from 1 to 5 do {_this addItemToVest "L115_5Rnd_338_Scenar_Mag_IR";};
...
hint "2-1 Mountain Troop Lead kit successfully loaded!";
sleep 15;
hintSilent "";
