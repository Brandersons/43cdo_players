...
//this addAction["<t color='#2E86C1'>Signaller</t>", {player execVM "Loadouts\Signaller.sqf";}, [],9,false,false,"","_this distance _target < 10"];
...
hint "3-1 Signaller kit successfully loaded!\n Specialist Role: Backpack changed!";
sleep 15;
hintSilent "";